...
<body>
    <header class="header">
        ...
        <p class="subtitle">Deja de perder clientes por no estar en el face.</p>
        <button>Contáctanos, nosotros te ayudamos</button>
        <picture>
        </picture>
    </header>
    <!-- Websites basicos -->
        ...
        <div class="content section-body">
            ...
            <div class="row flex-row">
                <div class="dos-tercios">
                    <h4 class="title-card">Características</h4>
